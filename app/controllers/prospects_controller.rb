class ProspectsController < ApplicationController
  ...
  private
    ...
    def prospect_params
      params.require(:prospect).permit(:company_name, :contact, :contact_email, :contact_title, :company_description, :company_url, :company_image_url, :company_bcorp_url, :responded)
    end
end
