  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved prospect as @prospect" do
        ...
        post :create, {:prospect => { "company_name" => "invalid value" }}, valid_session
        assigns(:prospect).should be_a_new(Prospect)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested prospect" do
        ...
        Prospect.any_instance.should_receive(:update).with({ "company_name" => "MyString" })
        put :update, {:id => prospect.to_param, :prospect => { "company_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the prospect as @prospect" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Prospect.any_instance.stub(:save).and_return(false)
        put :update, {:id => prospect.to_param, :prospect => { "company_name" => "invalid value" }}, valid_session
        assigns(:prospect).should eq(prospect)
      end
